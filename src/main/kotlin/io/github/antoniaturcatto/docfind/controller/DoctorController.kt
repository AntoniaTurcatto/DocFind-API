...
import io.github.antoniaturcatto.docfind.controller.mapper.DoctorMapper
...
class DoctorController(private val doctorService: DoctorService,
                       private val doctorMapper: DoctorMapper) : GenericController{
    ...
    fun search(
        ...
        val pageDTO = pageObtained.map { doctorMapper.toDTO(it) }
    ...
    fun save(@RequestBody @Valid doctorDTO: DoctorDTO): ResponseEntity<Any>{
        ...
        val location = gerarHeaderLocation(doctorEntity.id!!)
